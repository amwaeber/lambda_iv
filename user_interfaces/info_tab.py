...
class InfoWidget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setup_location_edit = QtWidgets.QLineEdit('%s' % defaults['info'][4], self)
        ...
        self.setup_calibrated_edit = QtWidgets.QLineEdit('%s' % defaults['info'][5], self)
        ...
        self.setup_suns_edit = QtWidgets.QLineEdit('%s' % defaults['info'][6], self)
        ...
        self.pid_prob_band_edit = QtWidgets.QLineEdit('%s' % defaults['info'][7], self)
        ...
        self.pid_integral_edit = QtWidgets.QLineEdit('%s' % defaults['info'][8], self)
        ...
        self.pid_derivative_edit = QtWidgets.QLineEdit('%s' % defaults['info'][9], self)
        ...
        self.pid_fuoc_edit = QtWidgets.QLineEdit('%s' % defaults['info'][10], self)
        ...
        self.pid_tcr1_edit = QtWidgets.QLineEdit('%s' % defaults['info'][11], self)
        ...
        self.pid_tcr2_edit = QtWidgets.QLineEdit('%s' % defaults['info'][12], self)
        ...
        self.pid_setpoint_edit = QtWidgets.QLineEdit('%s' % defaults['info'][13], self)
        ...
        self.room_temperature_edit = QtWidgets.QLineEdit('%s' % defaults['info'][14], self)
        ...
        self.room_humidity_edit = QtWidgets.QLineEdit('%s' % defaults['info'][15], self)
